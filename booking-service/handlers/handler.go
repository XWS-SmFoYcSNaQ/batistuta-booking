...
func (h BookingHandler) HostStandOutCheck(ctx context.Context, request *booking.EmptyMessage) (*booking.StandOutHost_Response, error) {
	return h.ReservationController.HostStandOutCheck(ctx, request)
}
