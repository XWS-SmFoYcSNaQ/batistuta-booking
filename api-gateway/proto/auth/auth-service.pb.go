...
var file_auth_auth_service_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x52, 0x6f, 0x6c, 0x65, 0x22, 0xb8, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12,
	...
	0x6e, 0x67, 0x50, 0x6c, 0x61, 0x63, 0x65, 0x22, 0x82, 0x01, 0x0a, 0x11, 0x52, 0x65, 0x67, 0x69,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2a, 0x1f, 0x0a, 0x08,
...
var file_auth_auth_service_proto_depIdxs = []int32{
	...
	1, // 5: auth.AuthService.Verify:input_type -> auth.Empty_Request
	7, // 6: auth.AuthService.Register:input_type -> auth.Register_Request
	5, // 7: auth.AuthService.Login:input_type -> auth.Authentication_Request
	2, // 8: auth.AuthService.Verify:output_type -> auth.Verify_Response
	8, // 9: auth.AuthService.Register:output_type -> auth.Register_Response
	6, // 10: auth.AuthService.Login:output_type -> auth.Authentication_Response
